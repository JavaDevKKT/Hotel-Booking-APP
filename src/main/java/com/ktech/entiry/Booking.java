...
public class Booking {
	...
	@ManyToOne(fetch = FetchType.EAGER) /// learn this
	@JoinColumn(name = "user_id") /// learn this
	private User user;

	@ManyToOne(fetch = FetchType.LAZY) /// learn this
	@JoinColumn(name = "room_id") /// learn this
	private Room room;
